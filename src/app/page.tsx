...
export default function HomePage() {
  return (
    <main id="content" className="min-h-screen overflow-x-hidden">
      ...
      <a
        href="#content"
        className="sr-only focus:not-sr-only fixed left-4 top-4 z-[100] rounded-xl border border-yellow-400/30 bg-gradient-to-r from-zinc-900/90 to-zinc-800/90 px-4 py-3 text-yellow-400 backdrop-blur-sm transition-all duration-300 hover:border-yellow-400/50 hover:shadow-glow focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2 focus:ring-offset-zinc-900"
      >
